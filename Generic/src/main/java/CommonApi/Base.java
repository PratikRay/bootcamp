...
public class Base {
    ...
    @BeforeMethod
    public void setUp(Boolean useCloudEnv, String userName,
    String key, String OS, String browser, String browserVersion, String url)throws IOException{
    ...
    public void hitKey(String locator){driver.findElement(By.cssSelector(locator));}
